...
This bundle exists because multiple imported signals point at the same database concept.
...
- proposal `seam_prisma_db_migrations` (maintained_db_migration_seam)

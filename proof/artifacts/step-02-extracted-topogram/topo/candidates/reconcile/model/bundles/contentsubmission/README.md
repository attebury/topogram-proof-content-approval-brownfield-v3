# ContentSubmission Candidate Bundle

Concept id: `entity_contentsubmission`
...
- Primary concept: `entity_contentsubmission`
- Primary entity: `entity_contentsubmission`
- Participants: _none_
...
This bundle exists because entity evidence converges on the same contentsubmission concept.
...
- `promote_entity` `entity_contentsubmission`

## Candidate Maintained Seam Mappings

- proposal `contentsubmission:entity:entity_contentsubmission` (entity)
...
- `entity_contentsubmission` from `prisma/schema.prisma`
